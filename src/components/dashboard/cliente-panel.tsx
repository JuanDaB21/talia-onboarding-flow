        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {data.mesas_cerradas} cuentas cerradas
            </p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-xs text-muted-foreground">Tasa de upselling</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-bold">{data.upselling_pct.toFixed(1)}%</div>
            <p className="text-xs text-muted-foreground mt-1">
              {data.pedidos_con_extras} / {data.pedidos_totales} pedidos con extras
            </p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-xs text-muted-foreground">Ventas del período</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-xs text-muted-foreground">
            Intensidad por monto de ventas (día × hora)
          </p>
        </CardHeader>
        <CardContent>
