ALTER TABLE public.negocio
  ADD COLUMN IF NOT EXISTS porcentaje_retencion_propina numeric NOT NULL DEFAULT 0
  CHECK (porcentaje_retencion_propina >= 0 AND porcentaje_retencion_propina <= 100);
